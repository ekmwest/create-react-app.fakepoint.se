        ...
        <>
            ...
            <div className={styles.content}>
                <div className={styles.notification_list}>
                    ...
                    <h3 className={styles.notification_title}>Today</h3>
                    <div className={styles.notification}>
                        <div className={styles.notification_header}>
                            <div className={styles.notification_icon}>
                                <img src="/icons/user.jpg" className={styles.notification_avatar}></img>
                    ...
                    <h3 className={styles.notification_title}>Yersterday</h3>
                    <div className={styles.notification}>
                        <div className={styles.notification_header}>
                            <div className={styles.notification_icon}>
                                <img src="/icons/user-4.jpeg" className={styles.notification_avatar}></img>
                            ...
                            <div className={styles.notification_content}>                               
                                <Link to={`/courses/2/messages/1`}>Sara Hansson has commented on your post</Link>
                            </div>
                            <div className={styles.notification_read}>
                            </div>
                        </div>
                    ...
                    <div className={styles.notification}>
                        ...
                        <div className={styles.notification_action}>
                            Informationsarkitektur 3 
                        </div>
                    </div>                   
                    <h3 className={styles.notification_title}>Friday</h3>
                    <div className={styles.notification}>
                        <div className={styles.notification_header}>
                            <div className={styles.notification_icon}>
                                <img src="/icons/user-4.jpeg" className={styles.notification_avatar}></img>
